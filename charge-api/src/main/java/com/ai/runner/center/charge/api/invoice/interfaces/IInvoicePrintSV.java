package com.ai.runner.center.charge.api.invoice.interfaces;
...
public interface IInvoicePrintSV {
     ...
     * @ApiCode CHG_0032
     */
    InvoiceTax queryInvoiceTax(InvoiceTaxQryParam param) throws CallerException;
     ...
     * @ApiCode CHG_0029
     */
    OrderInvoicePrintDetail queryOrderInvoicePrintDetail(OrderInvoicePrintReq req) throws CallerException;
     ...
     * @ApiCode CHG_0030
     */
    void saveTaxPrintLog(TaxPrintLog log) throws CallerException;
}
