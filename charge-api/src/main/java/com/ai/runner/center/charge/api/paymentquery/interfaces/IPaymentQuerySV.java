package com.ai.runner.center.charge.api.paymentquery.interfaces;
...
public interface IPaymentQuerySV {
     ...
     * @ApiCode CHG_0002
     */
    ChargeInfo queryChargeInfoByOrderId(PaymentQryParam param) throws CallerException;
     ...
     * @ApiCode CHG_0004
     */
    List<ChargePayTypeDetail> queryChargePayTypeDetailsByOrderId(PaymentQryParam param) throws CallerException;
     ...
     * @ApiCode CHG_0003
     */
    ChargeInfo queryChargeInfoByChargeId(ChargeIdParam param) throws CallerException;
     ...
     * @ApiCode CHG_0005
     */
    List<ChargePayTypeDetail> queryChargePayTypeDetailsByChargeId(ChargeIdParam param) throws CallerException;
     ...
     * @ApiCode CHG_0006
     */
    PageInfo<ChargeBaseInfo> queryChargeBaseInfoByAcctId(ChargeInfoQueryByAcctIdParam param) throws CallerException;
     ...
     * @ApiCode CHG_0007
     */
    PageInfo<ChargeBaseInfo> queryChargeBaseInfoByCustId(ChargeInfoQueryByCustIdParam param) throws CallerException;
}
